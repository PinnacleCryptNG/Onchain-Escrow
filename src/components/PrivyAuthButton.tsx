...
export const PrivyAuthButton: React.FC = () => {
  ...
  if (!profile.isAuthenticated || !profile.address) {
    return (
      <button
        ...
        className="h-8.5 sm:h-9.5 px-3 sm:px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold shadow-sm transition-all flex items-center gap-1.5 cursor-pointer shrink-0"
      >
  ...
  return (
    ...
    >
      <div className="w-5 h-5 rounded-lg bg-emerald-600/20 border border-emerald-500/30 flex items-center justify-center text-emerald-400 shrink-0">
